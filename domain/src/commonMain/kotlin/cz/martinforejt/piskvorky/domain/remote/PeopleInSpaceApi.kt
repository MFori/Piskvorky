package cz.martinforejt.piskvorky.domain.remote
...
class PeopleInSpaceApi(
    ...
    private val baseUrl: String = "http://localhost:9090/v1",
) : KoinComponent {
    suspend fun fetchPeople() = client.get<AstroResult>("$baseUrl/astros_local.json")
